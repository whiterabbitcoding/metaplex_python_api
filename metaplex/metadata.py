...
def get_metadata_account(mint_key):
    ...
    print("PublicKey.find_program_address")
    print(PublicKey(mint_key))
    print(
...
def get_metadata(client, mint_key):
    ...
    print("metadata_account")
    print(metadata_account)
    print((type(metadata_account)))
    print((dir(metadata_account)))
    print(client.get_account_info(metadata_account))
    print(dir(client.get_account_info(metadata_account)))
